...
def u_tilde_sia(np.ndarray[np.float64_t, ndim=1] u_tilde_ravel, np.ndarray[np.float64_t, ndim=3] sigma, int num_s, int num_p, int num_a_max, np.ndarray[np.int32_t, ndim=2] nums_a):
...
@cython.boundscheck(False)
@cython.wraparound(False)   
def u_tilde_sia_partial_beta(np.ndarray[np.float64_t, ndim=1] u_tilde_ravel, np.ndarray[np.float64_t, ndim=3] sigma, int num_s, int num_p, int num_a_max, np.ndarray[np.int32_t, ndim=2] nums_a):
...
@cython.boundscheck(False)
@cython.wraparound(False)
def u_tilde_sia_partial_V(np.ndarray[np.float64_t, ndim=1] phi_ravel, np.ndarray[np.float64_t, ndim=3] sigma, int num_s, int num_p, int num_a_max, np.ndarray[np.int32_t, ndim=2] nums_a):
...
@cython.boundscheck(False)
@cython.wraparound(False)
def u_tilde_sijab(np.ndarray[np.float64_t, ndim=1] u_tilde_ravel, np.ndarray[np.float64_t, ndim=3] sigma, int num_s, int num_p, int num_a_max, np.ndarray[np.int32_t, ndim=2] nums_a):
...
@cython.boundscheck(False)
@cython.wraparound(False)
def phi_tilde_siat(np.ndarray[np.float64_t, ndim=1] phi_ravel, np.ndarray[np.float64_t, ndim=3] sigma, int num_s, int num_p, int num_a_max, np.ndarray[np.int32_t, ndim=2] nums_a):
...
@cython.boundscheck(False)
@cython.wraparound(False)
def H_qre(np.ndarray[np.float64_t, ndim=1] y, u, phi, int num_s, int num_p, np.ndarray[np.int32_t, ndim=2] nums_a, int num_a_max, int num_a_tot):
...
@cython.boundscheck(False)
@cython.wraparound(False)
def J_qre(np.ndarray[np.float64_t, ndim=1] y, u, phi, int num_s, int num_p, np.ndarray[np.int32_t, ndim=2] nums_a, int num_a_max, int num_a_tot):
